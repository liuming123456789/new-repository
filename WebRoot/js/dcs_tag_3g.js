...
this.mall_cookie_utils||(this.mall_cookie_utils={},function(){
    mall_cookie_utils.getMallCookie=function(a){
        var b=document.cookie.split(";"),c="",d="",e="",f=!1,g="";
        for(g=0;g<b.length;g++){
            c=b[g].split("="),d=c[0].replace(/^\s+|\s+$/g,"");
            if(d==a)return f=!0,c.length>1&&(e=unescape(c[1].replace(/^\s+|\s+$/g,""))),e;
            c=null,d=""}if(!f)return null},
    mall_cookie_utils.isEmpty=function(a){
                return typeof a=="undefined"||a==="undefined|undefined"||a===null||a===""||a==="|"},
	mall_cookie_utils.getMallProvCode=function(){
		var a=mall_cookie_utils.getMallCookie("mallcity");
		return mall_cookie_utils.isEmpty(a)?"011":"0"+a.split("|")[0]},
	mall_cookie_utils.getMallCityCode=function(){
		var a=mall_cookie_utils.getMallCookie("mallcity");
		return mall_cookie_utils.isEmpty(a)?"110":a.split("|")[1]},
    mall_cookie_utils.getMuvT=function(){
        var a=mall_cookie_utils.getMallCookie("MUT_A");
        return mall_cookie_utils.isEmpty(a)?"":a},
    mall_cookie_utils.getMuvV=function(){
        var a=mall_cookie_utils.getMallCookie("MUT_V");
        return mall_cookie_utils.isEmpty(a)?"":a}}());
...
function dcsCookie(){
	...
	//10010 Mall Muv_T/Muv_V Cookie
	WT.Muv_T = mall_cookie_utils.getMuvT();
	WT.Muv_V = mall_cookie_utils.getMuvV();
