!function(e, t) {
    ...
    function w(e, t, n) {
        ...
        Bt.test(s) && It.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, 
    ...
    var it = function(e) {
        ...
        w = t.support = {}, N = t.isXML = function(e) {
            ...
            n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), 
            O = !N(r), w.attributes = i(function(e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && F.push("name" + nt + "*[*^$|!~]?="), 
            ...
            t = vt.test(H.compareDocumentPosition), M = t || vt.test(H.contains) ? function(e, t) {
    ...
    Z.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            }), t = (t || "").match(dt) || [ "" ], l = t.length; l--; ) a = jt.exec(t[l]) || [], 
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(dt) || [ "" ], l = t.length; l--; ) if (a = jt.exec(t[l]) || [], 
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Dt.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), 
            ...
            f = Z.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !Z.isWindow(r)) {
                    for (u = f.delegateType || d, Dt.test(u + d) || (s = s.parentNode); s; s = s.parentNode) p.push(s), 
                    a = s;
    ...
    Mt.th = Mt.td, Z.extend({
        ...
        buildFragment: function(e, t, n, r) {
            ...
            i || 0 === i) if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [ i ] : i); else if (qt.test(i)) {
                ...
                a = Mt[s] || Mt._default, o.innerHTML = a[1] + i.replace(At, "<$1></$2>") + a[2], 
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || Tn) + "").replace(pn, "").replace(vn, Cn[1] + "//"), 
            ...
            P(xn, f, t, w), 2 === x) return w;
            l = Z.event && f.global, l && 0 === Z.active++ && Z.event.trigger("ajaxStart"), 
            f.type = f.type.toUpperCase(), f.hasContent = !mn.test(f.type), i = f.url, f.hasContent || (f.data && (i = f.url += (fn.test(i) ? "&" : "?") + f.data, 
            delete f.data), f.cache === !1 && (f.url = dn.test(i) ? i.replace(dn, "$1_=" + cn++) : i + (fn.test(i) ? "&" : "?") + "_=" + cn++)), 
    ...
    Z.ajaxSetup({
        ...
        t.converters["script json"] = function() {
            ...
            e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Hn.push(i)), s && Z.isFunction(o) && o(s[0]), 
            s = o = void 0;
        }), "script") : void 0;
